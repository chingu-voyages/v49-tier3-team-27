...
const EventButtons = () => {
  ...
  return (
    <section className="w-full flex flex-row items-center justify-center gap-2">
        ...
        <Button onClick={() => router.push("/events/create")} className=" bg-interactive-green text-white hover:bg-interactive-green hover:bg-opacity-80 transition-colors duration-300">Create Event</Button>
    </section>
  )
}
